...
<div class="analytics-header">
    ...
    <button class="ai-button" onclick="openAIAnalysis('analytics')">
        🤖 AI Analysis
    </button>
</div>
...
function openAIAnalysis(type) {
    window.open('ai_analysis.php?type=' + type, 'AIAnalysis', 'width=900,height=700,resizable=yes,scrollbars=yes');
}
