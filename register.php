...
<div style="max-width:400px; margin:50px auto; font-family:sans-serif; padding:20px; border:1px solid #ccc; border-radius:8px;">
    <h2>Register Project / Organization</h2>
    <?php echo $msg; ?>
    <form method="POST">
        <input type="text" name="org_name" placeholder="Project ID (Organization Name)" required style="width:100%; padding:10px; margin-bottom:10px; box-sizing:border-box;">
